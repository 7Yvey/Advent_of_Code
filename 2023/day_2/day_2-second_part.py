...
def find_min_cube_num(required_colour, cube_colour, greatest_num, current_cube_col_num):
    if cube_colour == required_colour:
        if greatest_num < current_cube_col_num:
            greatest_num = current_cube_col_num
    return greatest_num



file = 'input_second_part'
...
for line in text:
    ...
    for start in range(len(game_sets)):
        ...
        for cube in cube_set:
           ...
           greates_num_red = find_min_cube_num('red', cube_colour, greates_num_red, colour_cube_num)
           
           greatest_num_blue = find_min_cube_num('blue', cube_colour, greatest_num_blue, colour_cube_num)
           
           greatest_num_green = find_min_cube_num('green', cube_colour, greatest_num_green, colour_cube_num) 
           

    #print(f"red {greates_num_red}")
   
    #print(f"green {greatest_num_green}")
    #print(f"blue {greatest_num_blue}")         
    game_result = greates_num_red * greatest_num_blue * greatest_num_green
    #print(game_result)
    
    game_sum_score += game_result
